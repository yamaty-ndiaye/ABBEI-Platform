...
# Reranker chargé une seule fois
_reranker = None
...
def repondre(question: str) -> dict:
    """Répond à une question via RAG avec reranking et Claude API"""
    vectorstore = charger_vectorstore()

    # 1. Récupérer plus de chunks que nécessaire
...
Réponse :"""
    ...
    # 7. Générer les liens Dropbox pour les sources
    dbx = get_client()
    sources = []
    vus = set()
